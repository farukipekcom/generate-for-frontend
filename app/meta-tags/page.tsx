...
export default function MetaTags() {
  return (
    <div className="w-full flex container columns-12 bg-white dark:bg-primary">
      <div className="w-[540px] border-r border-solid border-border">
        <div className="h-20 border-b border-solid border-border flex items-center pl-6 pr-6">
            ...
            <div className="flex">
              <div className="relative w-full">
                <input
                  type="search"
                  id="search"
                  className="block w-full z-20 placeholder:text-[#757C81] bg-transparent focus:placeholder:text-white outline-none focus:text-white font-semibold text-sm"
                  placeholder="Search"
                  required
                />
                <button
                  type="submit"
                  className="absolute top-0 right-0 text-sm bg-primary font-medium h-full text-white focus:outline-none ">
