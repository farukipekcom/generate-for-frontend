  ...
  return (
    <div className="flex">
      <div className="h-[calc(100vh-80px)] w-1/2 border-r border-solid border-borderLight p-6 dark:border-border">
        <Breadcrumbs count={2} page1="Twitter" page2="Summary" />
        <Title title="Summary" />
        <Description
          description={`Craft compelling Twitter Summary Cards effortlessly with our Code Generator. Elevate your tweet previews by adding concise and engaging snippets that entice users to explore your content further.`}
        />
